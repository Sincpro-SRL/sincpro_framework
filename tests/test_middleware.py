...
from sincpro_framework.middleware import Middleware, MiddlewarePipeline
...
class TestMiddlewareIntegration:
    ...
    def test_framework_with_middleware(self):
        ...
        @framework.feature(TransformedDTO)  # Feature expects TransformedDTO after transformation
...
class TestMiddlewareProtocol:
    ...
    def test_lambda_middleware(self):
        ...
        lambda_middleware = lambda dto: TransformedDTO(
            name=dto.name,
            age=dto.age,
            processed=False,
            timestamp="lambda"
        ) if isinstance(dto, OriginalDTO) else dto
